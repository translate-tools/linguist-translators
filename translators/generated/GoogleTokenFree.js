...
const basicFetcher = (url, _a) => __awaiter$2(void 0, void 0, void 0, function* () {
    var { responseType } = _a, options = __rest(_a, ["responseType"]);
...
class BaseTranslator {
    constructor(options) {
        ...
        this.fetch = (url, options) => __awaiter$1(this, void 0, void 0, function* () {
            var _a;
            const fetcher = (_a = this.options.fetcher) !== null && _a !== void 0 ? _a : basicFetcher;
 ...
 */
const languageAliases = new LanguageAliases(supportedLanguages, {
 ...
 */
const getFixedLanguage = (language) => { var _a; return (_a = languageAliases.get(language)) !== null && _a !== void 0 ? _a : language; };
...
function requireXpath () {
	if (hasRequiredXpath) return xpath$1;
	hasRequiredXpath = 1;
	(function (exports) {
		// non-node wrapper
		var xpath = exports;
...
var xpathExports = /*@__PURE__*/ requireXpath();
const xpath = /*@__PURE__*/getDefaultExportFromCjs(xpathExports);
...
function requireErrors () {
	...
	var conventions = /*@__PURE__*/ requireConventions();
...
function requireDom () {
	...
	var errors = /*@__PURE__*/ requireErrors();
	var DOMException = errors.DOMException;
	var DOMExceptionName = errors.DOMExceptionName;

	var g = /*@__PURE__*/ requireGrammar();
...
function requireDomParser () {
	...
	var conventions = /*@__PURE__*/ requireConventions();
	var dom = /*@__PURE__*/ requireDom();
	var errors = /*@__PURE__*/ requireErrors();
	var entities = /*@__PURE__*/ requireEntities();
	var sax = /*@__PURE__*/ requireSax();
...
function requireLib () {
	...
	var domParser = /*@__PURE__*/ requireDomParser();
...
const parseXMLResponse = (text) => {
    let doc;
    try {
        doc = new libExports.DOMParser().parseFromString(text, libExports.MIME_TYPE.XML_APPLICATION);
    }
    catch (err) {
        console.error(err);
        return null;
 ...
 */
class AbstractGoogleTranslator extends BaseTranslator {
        ...
        return getToken(text).then(({ value: tk }) => {
            ...
            return this.fetch(url, {
                ...
                const translatedText = rsp[0]
                    .map((chunk) => chunk instanceof Array && typeof chunk[0] === 'string'
                    ? chunk[0]
                    : '')
                    .join('');
            ...
            return this.fetch(url, {
                ...
                try {
                    ...
                    visitArrayItems(rawResp, (obj) => {
                        if (isSingleResponseMode && result.length === 1)
                            return;
...
globalThis.translator = GoogleTranslatorTokenFree;
