import { DeepLTranslator as BaseDeepLTranslator, DeepLTranslatorOptions } from 'anylang/esm/translators/DeepLTranslator';
...
(globalThis as any).translator = DeepLTranslator;